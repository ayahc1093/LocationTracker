package com.example.mcberliner.locationtracker;
...
/**
 * Created by mcberliner on 7/3/2015.
 */
    ...
    private class MyLocationListener implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            if (location != null) {
                ...
                manager.sendTextMessage(senderNumber, null, "http://maps.google.com/maps?q=" + location.getLatitude() + "," + location.getLongitude(), null, null);
